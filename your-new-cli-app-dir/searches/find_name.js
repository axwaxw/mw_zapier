...
const getList = (z, bundle) => {
  ...
  resourceBundle._legacyUrl = '{{url}}:{{port}}/REST/';
...
module.exports = {
  ...
  display: {
    label: 'Find Name',
    description: 'Finds an existing `name` based on `namecode` or `email`.',
    hidden: false,
    important: false
  },
  ...
  operation: {
    inputFields: [
      ...
      {
        key: 'search_string',
        label: 'Name Code or Email',
        helpText:
          'MoneyWorks will search for an existing _name_ based on the either the `namecode` or `email` fields.\nPlease note that if multiple _names_ have the same `email`, only the first _name_ will be selected.',
        type: 'string',
        required: false
      }
    ],
    ...
    sample: {
      ...
      address2: '',
      address3: 'Pleasantville',
      address4: '',
      address_country: 'New Zealand',
      after_hours: '',
      after_hours2: '212 1234',
      bank: 'First National',
      bank_account_number: '',
      bank_branch: '',
      category1: 'C',
      ...
      ddi2: '212 4567',
      debtor_terms: '-20',
      delivery1: '100 Main Street',
      delivery2: '',
      delivery3: 'Pleasantville',
      delivery4: '',
