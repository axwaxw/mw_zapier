...
var Zap = {
  ...
  create_name_pre_write: function (bundle) {
    ...
    */
    ...
    name_xml += fields.custom1 && '<Custom5>' + fields.custom1 + '</Custom5>' || '';
    name_xml += fields.custom2 && '<Custom6>' + fields.custom2 + '</Custom6>' || '';
    name_xml += fields.custom3 && '<Custom7>' + fields.custom3 + '</Custom7>' || '';
    name_xml += fields.custom4 && '<Custom8>' + fields.custom4 + '</Custom8>' || '';
